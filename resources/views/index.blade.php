...
<section class="hero-section set-bg" data-setbg="img/bg.jpg">
				...
				<div class="col-md-6">
					<div class="propertie-item set-bg" data-setbg="img/propertie/1.jpg">
						...
						<div class="propertie-info text-white">
							<div class="info-warp">
								<h5>176 Emmy close</h5>
								<p><i class="fa fa-map-marker"></i> Orji</p>
							</div>
							<div class="price">NGN1,777,000</div>
						</div>
					</div>
				</div>
				<div class="col-md-6">
	...
	<section class="services-section spad set-bg" data-setbg="img/service-bg.jpg">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 offset-lg-1 pl-lg-0 mb-5">
					<div class="section-title text-white">
						<h3>OUR SERVICES</h3>
						<p>We provide the perfect services for </p>
					</div>
					<div class="services">
						<div class="service-item">
							<i class="fa fa-briefcase"></i>
							<div class="service-text">
								<h5>Buying, Selling and Renting</h5>
								<p>Buy, rent and sell all kinds of real estate properties
								such as houses, estates, lands, office buildings, complexes, plazas, etc.</p>
							</div>
						</div>
						<div class="service-item">
							...
							<div class="service-text">
								...
								<p> Make money by just by becoming our agent. Our numerous incentive packages are just right for your every efforts.</p>
							</div>
						</div>
						<div class="service-item">
							...
							<div class="service-text">
								...
								<p> Benefit from our wealth of experience in real estate as we guide you in real estate activities such as investments, litigation, etc.</p>
							</div>
						</div>
						<div class="service-item">
							...
							<div class="service-text">
								...
								<p> Manage all the property under your care from one place. See how much your property is valued at and increase your sales.</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 f-cata">
					...
					<h5><a href="categories.php"> Apartment for rent</a></h5>
				</div>
				<div class="col-lg-3 col-md-6 f-cata">
					<img src="img/feature-cate/2.jpg" alt="">
					<h5><a href="#"> Estate Homes </a></h5>
				</div>
				<div class="col-lg-3 col-md-6 f-cata">
					<img src="img/feature-cate/3.jpg" alt="">
					<h5><a href="#"> Resort Villas </a></h5>
				</div>
				<div class="col-lg-3 col-md-6 f-cata">
	...
	<section class="blog-section spad">
		<div class="container">
			<div class="section-title text-center">
				<h3>LATEST NEWS</h3>
				<p>Real estate news headlines around your place.</p>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6 blog-item">
					...
					<div class="blog-meta">
						<span><i class="fa fa-user"></i>findmyhouse</span>
